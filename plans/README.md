...
Plan 039 was approved separately on 2026-09-17 against `ca5419b` and is in progress.
...
| 021  | Decide and execute the xmldom 0.9 migration                            | P3       | M      | —                 | DONE        |
...
Status values: DRAFT | TODO | IN PROGRESS | DONE | BLOCKED (with one-line reason) | REJECTED
