...
<qti-assessment-item xmlns="http://www.imsglobal.org/xsd/imsqtiasi_v3p0" identifier="${id}" title="${id}" time-dependent="false" xml:lang="en">
  ...
  <qti-item-body>
    ...
    <qti-gap-match-interaction response-identifier="GAP_RESPONSE" max-associations="2" class="qti-gap-placement qti-choices-left" data-choices-container-width="160">
...
function renderInteractionXml(qtiName: string, interactionType: QtiInteractionType): string {
  ...
  if (interactionType === "positionObject") {
    return `<div>Drag the field-note marker onto the Collect water data step in the workflow.</div><qti-position-object-stage><object data="${deliveryFlowImage}" type="image/svg+xml" width="480" height="300"/><${qtiName} response-identifier="RESPONSE"><object data="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2064%2048'%3E%3Crect%20x='4'%20y='4'%20width='56'%20height='40'%20rx='8'%20fill='%23fff3bf'%20stroke='%23212529'%20stroke-width='4'/%3E%3Cpath%20d='M32%2044%20L24%2058%20L40%2058%20Z'%20fill='%23fff3bf'%20stroke='%23212529'%20stroke-width='4'/%3E%3C/svg%3E" type="image/svg+xml" width="64" height="48"/></${qtiName}></qti-position-object-stage>`;
  }
  if (interactionType === "upload") {
