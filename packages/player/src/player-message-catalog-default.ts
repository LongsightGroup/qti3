...
export const defaultPlayerMessageCatalog: PlayerMessageCatalog = {
  ...
  strings: {
    ...
    extendedTextCounter: "{count} / {expectedLength}",
    ...
    richTextToolbarLabel: "Rich text formatting",
    richTextToolbarFormattingGroup: "Text formatting",
    richTextToolbarListsGroup: "Lists",
    richTextToolbarHistoryGroup: "Undo and redo",
    richTextBold: "Bold",
