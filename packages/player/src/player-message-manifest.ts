...
export const PLAYER_MESSAGE_MANIFEST = [
  ...
  { key: "richTextToolbarLabel", resolver: "plain" },
  { key: "richTextToolbarFormattingGroup", resolver: "plain" },
  { key: "richTextToolbarListsGroup", resolver: "plain" },
  { key: "richTextToolbarHistoryGroup", resolver: "plain" },
  { key: "richTextBold", resolver: "plain" },
  { key: "richTextItalic", resolver: "plain" },
  { key: "richTextUnderline", resolver: "plain" },
  { key: "richTextBulletedList", resolver: "plain" },
  { key: "richTextNumberedList", resolver: "plain" },
  { key: "richTextUndo", resolver: "plain" },
  { key: "richTextRedo", resolver: "plain" },
