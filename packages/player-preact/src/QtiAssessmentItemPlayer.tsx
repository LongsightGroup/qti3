...
>(function QtiAssessmentItemPlayer(props, ref) {
  ...
  useLayoutEffect(() => {
    ...
    validateResponses,
    showFeedback,
    props.loadOptions?.sessionOptions?.randomSeed,
    props.loadOptions?.sessionOptions?.customOperators,
    props.loadOptions?.sessionOptions?.allowedUndeclaredResponseIdentifiers,
    fetchXml,
    resolveAsset,
    resolveStylesheet,
  ]);
