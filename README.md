...
`pnpm certification:check` fail fast unless official external QTI content is
...
The full certification gate also writes and checks reproducible item evidence for a
